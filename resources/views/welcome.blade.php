            ...
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-md-6">
                    ...
                    <div class="d-flex mt-2">
                        ...
                        <div>
                            <img class="card-sub-img" style="margin-left: 10px" src="{{asset('uploads/img2.png')}}"
                                 alt="">
                        </div>
                        <div>
                            <img class="card-sub-img" style="margin-left: 10px" src="{{asset('uploads/img3.png')}}"
                                 alt="">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <p class="lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium at dolorem
                                    quidem
                                    modi. Nam sequi consequatur obcaecati excepturi alias magni, accusamus eius
                                    blanditiis delectus
...
{{--                            </div>--}}
{{--                            <div class="col-md-4 my-2">--}}
{{--                                <a href="{{route('twocheckout.payment')}}" type="submit"--}}
